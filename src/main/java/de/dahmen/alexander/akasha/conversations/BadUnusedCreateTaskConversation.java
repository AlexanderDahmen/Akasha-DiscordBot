 ...
 */
@Deprecated
public class BadUnusedCreateTaskConversation implements Conversation {
    ...
    public BadUnusedCreateTaskConversation(JdaUserRepository users, JdaTaskRepository tasks) {
        this.users = users;
        this.tasks = tasks;
